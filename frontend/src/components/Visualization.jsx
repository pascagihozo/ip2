  ...
  return (
    <Container className=''>
      <Row className='mt-24 p-4'>
        <Col xl={9} sm={12}>
        <input onChange={(e) => setKeyword(e.target.value)} className='p-2 w-100 bg-white text-black' type="text" placeholder="Enter job name and location" />
        </Col>
        <Col xl={3} sm={12}>
        <Button onClick={() => handleSearch(keyword)} className='p-2 bg-primary w-100'>Search</Button>
        </Col>
        </Row>
